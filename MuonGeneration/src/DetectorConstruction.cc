...
G4VPhysicalVolume* DetectorConstruction::Construct() {
    ...
    G4LogicalVolume* airtunnelLogical = new G4LogicalVolume(airtunnel, materials["air"], "rockLogical",0,0,0);
    G4VPhysicalVolume* airtunnelPhys = new G4PVPlacement(rot, G4ThreeVector(0, 0, -myConf->getRockSizeZ()/2.0), airtunnelLogical, "airtunnelPhysical", rockLogical, false, 0);
